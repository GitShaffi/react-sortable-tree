	...
	*/
    ...
    function(module, exports, __webpack_require__) {
        ...
        function canDrop(dropTargetProps, monitor) {
            ...
            var targetDepth = getTargetDepth(dropTargetProps, monitor), draggedNode = monitor.getItem().node, parentPath = dropTargetProps.path.slice(0, -1), parentNode = dropTargetProps.rows.find(function(row) {
